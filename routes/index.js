    ...
    Product.find(function(err, items) {
      if(err) {
        ...
        if(req.user.admin === 'true')
          res.render('index', { title: 'Products', products: items, userFirstName: req.user.fullname, userAdmin: true});
        else
          res.render('index', { title: 'Products', products: items, userFirstName: req.user.fullname, userAdmin: undefined});
      }
    });
  }
  else
